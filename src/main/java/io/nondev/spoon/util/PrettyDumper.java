...
public class PrettyDumper {
    ...
    private class TreePrinterListener implements ParseTreeListener {
        ...
        private final StringBuilder builder = new StringBuilder();
        private final Map<ParseTree, ArrayList<String>> stack = new HashMap<>();
        ...
        public void enterEveryRule(ParserRuleContext ctx) {
            ...
            final String ruleName = ruleIndex >= 0 && ruleIndex < ruleNames.size()
        ...
        public void exitEveryRule(ParserRuleContext ctx) {
            ...
            for (int i = 1; i < ruleStack.size(); i++) {
                sb.append(" ").append(ruleStack.get(i));
            }
